...
@Schema(description = "Request model for debiting money from an account")
public record DebitRequest(
    ...
    @Schema(description = "Amount to debit", example = "50.00", requiredMode = Schema.RequiredMode.REQUIRED)
